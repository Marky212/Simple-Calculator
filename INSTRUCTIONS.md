...
Hello! Thank you for reviewing my task. In order to run it just do the following:
After unzipping the project, just run these commands:
npm install
npm start
the calculator should open in your browser after a minute or so.
Thank you!
